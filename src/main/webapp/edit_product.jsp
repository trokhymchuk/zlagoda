...
<div class="container">
    ...
    <form action="javascript:submit('<%= request.getParameter("id")%>');">
        <div class="row mb-3">
            ...
            <div class="col-sm-10">
                <input type="text"  minlength="3" required name="name" class="form-control" id="inputEmail3"
                       value="${result.rows[0].product_name}">
            </div>
        </div>
        <div class="row mb-3">
        ...
        <div class="mb-3">
            ...
            <textarea name="characteristics" class="form-control" id="exampleFormControlTextarea1"
                      rows="3">${result.rows[0].characteristics}</textarea>
        </div>
