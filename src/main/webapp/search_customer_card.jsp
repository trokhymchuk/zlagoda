...
<sql:query dataSource="${snapshot}" var="result">
    SELECT * from Customer_Card WHERE percent = <%= request.getParameter("percent")%> ORDER BY cust_surname;
</sql:query>

<div class="container">
    <form id="searchForm">
        <div class="input-group mb-3">
            <input type="number" class="form-control" placeholder="Enter percent of the card" name="percent" id="percent" min="0" max="100" value="">
